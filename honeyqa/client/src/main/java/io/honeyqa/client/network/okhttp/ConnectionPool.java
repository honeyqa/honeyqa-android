 ...
 * requests that share the same {@link io.honeyqa.client.network.okhttp.Address} may share a
 * {@link io.honeyqa.client.network.okhttp.Connection}. This class implements the policy of

...
import io.honeyqa.client.network.okhttp.Authenticator;
import io.honeyqa.client.network.okhttp.Challenge;
...
import static io.honeyqa.client.network.okhttp.internal.Util.equal;
...
public final class OkHeaders {
   ...
   * {@link io.honeyqa.client.network.okhttp.Protocol protocol} ("spdy/3.1", "http/1.1", etc).
   */

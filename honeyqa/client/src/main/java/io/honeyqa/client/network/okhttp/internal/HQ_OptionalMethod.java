...
class HQ_OptionalMethod<T> {
   ...
   */
  public HQ_OptionalMethod(Class<?> returnType, String methodName, Class... methodParams) {
   ...
   * the {@link HQ_OptionalMethod} was created. If the return type is specified (i.e. non-null) it

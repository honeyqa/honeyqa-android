 ...
 */
public final class HQ_Route {
  final HQ_Address address;
  final Proxy proxy;
  final InetSocketAddress inetSocketAddress;

  public HQ_Route(HQ_Address address, Proxy proxy, InetSocketAddress inetSocketAddress) {
    if (address == null) {
   ...
   *
   * <strong>Warning:</strong> This may disagree with {@link HQ_Address#getProxy}
  ...
  @Override public boolean equals(Object obj) {
    if (obj instanceof HQ_Route) {
      HQ_Route other = (HQ_Route) obj;

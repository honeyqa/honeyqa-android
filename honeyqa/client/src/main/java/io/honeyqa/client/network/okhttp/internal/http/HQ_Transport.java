...
public interface HQ_Transport {
  ...
  Sink createRequestBody(HQ_Request request, long contentLength) throws IOException;

  /** This should update the HTTP engine's sentRequestMillis field. */
  void writeRequestHeaders(HQ_Request request) throws IOException;

  /**
   * Sends the request body returned by {@link #createRequestBody} to the
   * remote peer.
   */
  void writeRequestBody(HQ_RetryableSink requestBody) throws IOException;

  /** Flush the request to the underlying socket. */
  void finishRequest() throws IOException;

  /** Read and return response headers. */
  HQ_Response.Builder readResponseHeaders() throws IOException;

  /** Returns a stream that reads the response body. */
  HQ_ResponseBody openResponseBody(HQ_Response response) throws IOException;
  ...
  void disconnect(HQ_HttpEngine engine) throws IOException;

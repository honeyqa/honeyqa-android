 ...
 * <a href="https://github.com/twitter/hpack">Twitter HQ_Hpack</a>.
 * <ul>
...
class HQ_Huffman {
  ...
  private static final HQ_Huffman INSTANCE = new HQ_Huffman();

  public static HQ_Huffman get() {
    return INSTANCE;
  }
  ...
  private static final class Node {
     ...
     * @param bits length of HQ_Huffman code in bits
     */

...
import io.honeyqa.client.network.okhttp.Address;
import io.honeyqa.client.network.okhttp.CertificatePinner;
...
import io.honeyqa.client.network.okhttp.Interceptor;
...
import io.honeyqa.client.network.okhttp.Route;
import io.honeyqa.client.network.okhttp.internal.Internal;
import io.honeyqa.client.network.okhttp.internal.InternalCache;
import io.honeyqa.client.network.okhttp.internal.Util;
import io.honeyqa.client.network.okhttp.internal.Version;
...
import static io.honeyqa.client.network.okhttp.internal.Util.closeQuietly;
import static io.honeyqa.client.network.okhttp.internal.http.StatusLine.HTTP_CONTINUE;
import static io.honeyqa.client.network.okhttp.internal.http.StatusLine.HTTP_PERM_REDIRECT;
import static io.honeyqa.client.network.okhttp.internal.http.StatusLine.HTTP_TEMP_REDIRECT;

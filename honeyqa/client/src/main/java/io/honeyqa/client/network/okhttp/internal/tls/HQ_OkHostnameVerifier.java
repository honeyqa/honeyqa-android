...
package io.honeyqa.client.network.okhttp.internal.tls;
 ...
 */
public final class HQ_OkHostnameVerifier implements HostnameVerifier {
  public static final HQ_OkHostnameVerifier INSTANCE = new HQ_OkHostnameVerifier();
  ...
  private boolean verifyHostName(String hostName, X509Certificate certificate) {
    ...
    if (!hasDns) {
      ...
      String cn = new HQ_DistinguishedNameParser(principal).findMostSpecific("cn");
      if (cn != null) {

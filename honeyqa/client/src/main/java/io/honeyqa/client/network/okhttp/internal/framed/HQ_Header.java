...
public final class HQ_Header {
  ...
  public HQ_Header(String name, String value) {
    this(ByteString.encodeUtf8(name), ByteString.encodeUtf8(value));
  }

  public HQ_Header(ByteString name, String value) {
    this(name, ByteString.encodeUtf8(value));
  }

  public HQ_Header(ByteString name, ByteString value) {
    this.name = name;
    this.value = value;
  ...
  @Override public boolean equals(Object other) {
    if (other instanceof HQ_Header) {
      HQ_Header that = (HQ_Header) other;

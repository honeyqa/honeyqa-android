...
import static io.honeyqa.client.network.okhttp.internal.Util.checkOffsetAndCount;
import static io.honeyqa.client.network.okhttp.internal.http.StatusLine.HTTP_CONTINUE;
import static io.honeyqa.client.network.okhttp.internal.http.Transport.DISCARD_STREAM_TIMEOUT_MILLIS;

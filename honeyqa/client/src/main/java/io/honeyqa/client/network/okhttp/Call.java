...
import io.honeyqa.client.network.okhttp.internal.http.RequestException;
import io.honeyqa.client.network.okhttp.internal.http.RouteException;
import java.io.IOException;
import java.net.ProtocolException;
import java.util.logging.Level;

import static io.honeyqa.client.network.okhttp.internal.Internal.logger;
import static io.honeyqa.client.network.okhttp.internal.http.HttpEngine.MAX_FOLLOW_UPS;

...
public enum HQ_Protocol {
   ...
   * {@linkplain HQ_CipherSuite#TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256}
   ...
   */
  public static HQ_Protocol get(String protocol) throws IOException {

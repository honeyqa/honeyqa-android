...
import io.honeyqa.client.network.okhttp.ResponseBody;
import io.honeyqa.client.network.okhttp.internal.Util;
import io.honeyqa.client.network.okhttp.internal.framed.ErrorCode;
import io.honeyqa.client.network.okhttp.internal.framed.FramedConnection;
import io.honeyqa.client.network.okhttp.internal.framed.FramedStream;
import io.honeyqa.client.network.okhttp.internal.framed.Header;
...
import static io.honeyqa.client.network.okhttp.internal.framed.Header.RESPONSE_STATUS;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.TARGET_AUTHORITY;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.TARGET_HOST;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.TARGET_METHOD;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.TARGET_PATH;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.TARGET_SCHEME;
import static io.honeyqa.client.network.okhttp.internal.framed.Header.VERSION;

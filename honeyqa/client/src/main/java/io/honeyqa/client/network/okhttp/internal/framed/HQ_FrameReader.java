...
public interface HQ_FrameReader extends Closeable {
  ...
  interface Handler {
    ...
    void headers(boolean outFinished, boolean inFinished, int streamId, int associatedStreamId,
                 List<HQ_Header> headerBlock, HQ_HeadersMode headersMode);
    void rstStream(int streamId, HQ_ErrorCode errorCode);
    void settings(boolean clearPrevious, HQ_Settings settings);
     ...
     */
    void goAway(int lastGoodStreamId, HQ_ErrorCode errorCode, ByteString debugData);

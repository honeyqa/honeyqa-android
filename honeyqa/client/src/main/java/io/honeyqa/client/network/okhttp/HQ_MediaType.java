 ...
 */
public final class HQ_MediaType {
  ...
  private HQ_MediaType(String mediaType, String type, String subtype, String charset) {
   ...
   */
  public static HQ_MediaType parse(String string) {
    ...
    return new HQ_MediaType(string, type, subtype, charset);
  }
  ...
  @Override public boolean equals(Object o) {
    return o instanceof HQ_MediaType && ((HQ_MediaType) o).mediaType.equals(mediaType);
  }
